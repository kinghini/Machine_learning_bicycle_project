...
def predict():
    context = {
        Bike_DATA_KEY: None,
        MEDIAN_Bike_VALUE_KEY: None
    }

    if request.method == 'POST':
        instant =int (request.form['instant'])
        ...
        Bike_data = BikeData( instant = instant,
                               season = season,
                                yr = yr,
                               month = month,
                               hr=hr,
        ...
        Bike_df = Bike_data.get_Bike_input_data_frame()
        Bike_predictor = BikePredictor(model_dir=MODEL_DIR)
        median_Bike_value = Bike_predictor.predict(X=Bike_df)
        context = {
            Bike_DATA_KEY: Bike_data.get_Bike_data_as_dict(),
            MEDIAN_Bike_VALUE_KEY: median_Bike_value,
        }
